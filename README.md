...
Avem nevoie de un folder login, în interiorul folderului wwwroot în care avem doua fișiere login.html și login.js. Pentru a testa dacă totul merge bine în fișierul login.html, în body vom scrie intre doua seturi de acolade 1 + 2 . Și înainte de a rula programul nu uitam să introducem în index.html noul fișier javascript.
